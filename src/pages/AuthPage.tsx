...
import { getAuthRedirectUrl } from '@/lib/authConfig';
...
const AuthPage = () => {
  ...
  const handleGoogleLogin = async () => {
    if (!isSupabaseConfigured) {
      toast.error(
        'Auth is not configured. Add VITE_SUPABASE_URL and VITE_SUPABASE_PUBLISHABLE_KEY in Vercel, then redeploy.'
      );
      return;
    }
      ...
      <div className="w-full max-w-md animate-fade-in">
        <div className="mb-8 text-center">
          <div className="mb-4 flex items-center justify-center gap-2">
            ...
            <h1 className="text-3xl font-bold font-display gradient-text">LevelUp</h1>
          </div>
          <p className="text-muted-foreground">
            Close the gap between where you are and your dream job
          </p>
        </div>
